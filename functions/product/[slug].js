...
<html lang="en">
  ...
  <body class="shop-page product-page">
    <header class="site-header">
      ...
      <nav id="site-nav" class="site-nav" aria-label="Main navigation"><a href="/#services">Services</a><a href="/shop">Shop</a><a class="nav-cart-link" href="/cart" data-cart-link>Cart <span data-cart-count hidden>0</span></a><a href="/#work">Our Work</a><a href="/#story">About</a><a href="/#quote">Get a Quote</a></nav>
    </header>
    <main>${body}</main>
